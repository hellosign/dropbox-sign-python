...
from dropbox_sign.api_response import ApiResponse, T as ApiResponseT
import dropbox_sign.models
from dropbox_sign import rest
from dropbox_sign.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(dropbox_sign.models, klass)
